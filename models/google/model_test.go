...
func TestNewModel(t *testing.T) {
	model := NewModel("test-api-key", "gemini-pro",
	...
	if model.modelID != "gemini-pro" {
		t.Errorf("Expected modelID to be 'gemini-pro', got %s", model.modelID)
	}
...
func TestInterfaceCompliance(t *testing.T) {
	model := NewModel("test-key", "gemini-pro")
...
func TestContextTimeout(t *testing.T) {
	model := NewModel("invalid-key", "gemini-pro")
